...
('mobile','default','article_browse','top','[{"id":"block4","grid":"0","titleless":"0","borderless":"0"}]','no','zh-tw'),
('mobile','default','article_view','top','[{"id":"block4","grid":"0","titleless":"0","borderless":"0"}]','no','zh-tw'),
('mobile','default','product_browse','top','[{"id":"block5","grid":"0","titleless":"0","borderless":"0"}]','no','zh-tw'),
('mobile','default','product_view','top','[{"id":"block5","grid":"0","titleless":"0","borderless":"0"}]','no','zh-tw'),
('mobile','default','page_view','top','[{"id":"block6","grid":"0","titleless":"0","borderless":"0"}]','no','zh-tw');
