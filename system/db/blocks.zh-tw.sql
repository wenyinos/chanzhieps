...
("block2", 'hotArticle', '熱門文章', '{"category":"0","limit":"7"}', 'default'),
("block3", 'latestProduct', '最新產品', '{"category":"0","limit":"3","image":"show"}', 'default'),
("block4", 'hotProduct', '熱門產品', '{"category":"0","limit":"3","image":"show"}', 'default'),
("block5", 'slide', '幻燈片', '', 'default'),
("block6", 'articleTree', '文章分類', '{"showChildren":"0"}', 'default'),
("block7", 'productTree', '產品分類', '{"showChildren":"0"}', 'default'),
("block8", 'blogTree', '博客分類', '{"showChildren":"1"}', 'default'),
("block9", 'contact', '聯繫我們', '', 'default'),
("block10", 'about', '公司簡介', '', 'default'),
("block11", 'links', '友情鏈接', '', 'default'),
("block12", 'header', '網站頭部', '', 'default'),
("block13", 'followUs', '關注我們', '', 'default');
