...
?>
<div class='container'>
  <div class='center-focus' style='max-width: 1000px'>
    <div class='panel-pure panel'>
      <div class='panel-heading'><strong><?php echo $lang->install->checking;?></strong></div>
      <table class='table table-bordered'>
        ...
        <tr>
          <td colspan='4'><?php echo '<p class="small text-left">' . '<strong>' . $lang->install->phpINI . '</strong><br />' . nl2br($this->install->getIniInfo()) . '</p>';?></td>
        </tr>
        <?php endif;?>
        </tfoot>
      </table>
