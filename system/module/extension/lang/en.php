<?php
/**
 * The extension module en file of ChanZhiEPS.
 *
...
$lang->extension->latest      = '<small>Latest:<strong><a href="%s" target="_blank" class="extension">%s</a></strong>，need zentao <a href="http://api.chanzhi.org/goto.php?item=latest" target="_blank"><strong>%s</strong></small>';
...
$lang->extension->successUploadedPackage   = 'Successfully uploaded the package file.';
...
$lang->extension->errorGetModules              = "Get extensions' categories data from the www.chanzhi.org failed. ";
$lang->extension->errorGetExtensions           = 'Get extensions from www.chanzhi.org failed. You can visit <a href="http://www.chanzhi.org/extension/" target="_blank">www.chanzhi.org</a> to find your extensions, download it manually and then upload to zentaopms to install it.';
