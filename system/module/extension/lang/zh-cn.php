<?php
/**
 * The extension module zh-cn file of ChanZhiEPS.
 *
...
$lang->extension->latest      = '<small>最新版本<strong><a href="%s" target="_blank" class="extension">%s</a></strong>，兼容蝉知<a href="http://api.chanzhi.org/goto.php?item=latest" target="_blank" class="alert-link"><strong>%s</strong></a></small>';
...
$lang->extension->successUploadedPackage   = '成功上传插件';
...
$lang->extension->errorGetModules              = '从www.chanzhi.org获得插件分类失败。可能是因为网络方面的原因，请检查后重新刷新页面。';
$lang->extension->errorGetExtensions           = '从www.chanzhi.org获得插件失败。可能是因为网络方面的原因，您可以到 <a href="http://www.chanzhi.org/extension/" target="_blank" class="alert-link">www.chanzhi.org</a> 手工下载插件，然后上传安装。';
...
$lang->extension->errorCheckIncompatible       = '该插件与蝉知版本不兼容，%s后可能无法使用。。<h3>您可以选择 <a href="%s">强制%s</a> 或者 <a href="#" onclick=parent.location.href="%s">取消</a></h3>';
...
$lang->extension->errorIncompatible            = '该插件与您的蝉知版本不兼容';
