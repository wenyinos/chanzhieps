<?php
/**
 * The erase view file of extension module of ChanZhiEPS.
 *
...
<div class='alert alert-success'>
  ...
  <div class='content'>
    ...
    <?php endif;?>
    <p class='text-center'><?php echo html::a(inlink('browse', 'type=available'), $lang->extension->viewAvailable, "class='btn'");?></p>
  </div>
</div>
