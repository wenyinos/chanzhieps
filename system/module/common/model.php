...
class commonModel extends model
{
    ...
    public static function createManagerMenu()
    {
        ...
        $string .= sprintf('<ul class="dropdown-menu"><li>%s</li><li>%s</li><li>%s</li><li>%s</li></ul>', html::a(helper::createLink('user', 'changePassword'), $lang->changePassword, "data-toggle='modal'"), html::a(helper::createLink('user', 'accountSetting'), $lang->accountSetting), html::a(helper::createLink('misc', 'about'), $lang->about, "data-toggle='modal'"), html::a(helper::createLink('misc','thanks'), $lang->thanks, "data-toggle='modal'"), html::a(helper::createLink('user','logout'), $lang->logout));
        $string .= '</li></ul>';
