  ...
  <table class='table table-hover table-striped'>
    ...
    <tbody>
      ...
      <tr class='text-center'>
        ...
        <td class='text-left'><strong><?php echo $speakers[$thread->author];?></strong></td>
        ...
        <td class='text-left'>
          ...
          if($thread->replies)
          {
              ...
              echo html::a($this->createLink('thread', 'locate', "threadID={$thread->id}&replyID={$thread->replyID}"), $speakers[$thread->repliedBy]);
          }
          ?>
        </td>  
      </tr>
      ...
      <tr class='text-center'>
        ...
        <td style='width:120px' class='text-left'><strong><?php echo $speakers[$thread->author];?></strong></td>
