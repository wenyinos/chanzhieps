  ...
  <div class='panel'>
    ...
    <div class='panel-body'>
      ...
      foreach($children as $child)
      {
          ...
          if(!$isWeichatMenu) echo "<div class='col-xs-6 col-md-4'>" . html::input("alias[$child->id]", $child->alias, "class='form-control' placeholder='{$this->lang->category->alias}'") . '</div>';
          echo "</div>";
      ...
      for($i = 0; $i < $newChildrenCount; $i ++)
      {
          ...
          if(!$isWeichatMenu) echo "<div class='col-xs-6 col-md-4'>" . html::input("alias[]", '', "class='form-control' placeholder='{$this->lang->category->alias}'") . '</div>';
          echo "</div>";
