...
// $config->ui->selectorOptions['basic']['colorset']['primaryColor'] = array('type' => 'color', 'default' => '#3280FC');
// $config->ui->selectorOptions['basic']['colorset']['backcolor']    = array('type' => 'color', 'default' => '#FFF');
// $config->ui->selectorOptions['basic']['colorset']['forecolor']    = array('type' => 'color', 'default' => '#333');
