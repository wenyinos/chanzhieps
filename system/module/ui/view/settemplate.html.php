        ...
        <?php foreach($template['themes'] as $theme => $name):?>
          ...
          <div class='theme<?php echo $currentClass;?>' data-url='<?php echo $url;?>' data-theme='<?php echo $theme;?>'>
            <div class='theme-card'>
              ...
              <?php if($custom):?>
              <?php echo html::a(inlink('customTheme', "theme={$theme}&template={$code}"), "<span class='icon-cog'></span>", "class='btn btn-primary btn-custom' data-size='fullscreen' data-toggle='modal' data-type='ajax' data-backdrop='true'") ?>
              <?php endif;?>
