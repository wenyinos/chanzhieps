<div class='modal-dialog w-1000px'>
  <div class='modal-content'>
    ...
    <form method='post' id='qrcodeForm' enctype='multipart/form-data' action="<?php echo inlink('qrcode', "public={$public}")?>">
        <table class='table table-form'>
          <tr>
            <?php if(!empty($qrcodeFile)) echo '<td>' . html::image($qrcodeFile) . '</td>';?>
