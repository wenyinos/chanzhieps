 ...
 *
 * @copyright   Copyright 2009-2013 青島易軟天創網絡科技有限公司 (QingDao XiRang Network Infomation Co,LTD www.xirangit.com)
...
$lang->package->latest      = '<small>最新版本<strong><a href="%s" target="_blank" class="package">%s</a></strong>，兼容禪道<a href="http://api.chanzhi.org/goto.php?item=latest" target="_blank" class="alert-link"><strong>%s</strong></a></small>';
...
$lang->package->errorGetPackages           = '從www.chanzhi.org獲得插件失敗。可能是因為網絡方面的原因，您可以到 <a href="http://www.chanzhi.org/package/" target="_blank" class="alert-link">www.chanzhi.org</a> 手工下載插件，然後上傳安裝。';
...
$lang->package->errorPackageFileExists       = '下載路徑已經有一個名為的<strong>%s</strong>附件。<h3>重新%s，<a href="%s" class="alert-link">請點擊此連結</a></h3>';
...
$lang->package->errorCheckIncompatible       = '該插件與禪道版本不兼容，%s後可能無法使用。。<h3>您可以選擇 <a href="%s">強制%s</a> 或者 <a href="#" onclick=parent.location.href="%s">取消</a></h3>';
...
$lang->package->errorIncompatible            = '該插件與您的禪道版本不兼容';
