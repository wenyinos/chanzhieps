...
<tr>
  <th><?php echo $lang->block->productType;?></th>
  <td><?php echo html::select('params[productTypeList]', $lang->block->productTypeList, isset($block->content->productTypeList) ? $block->content->productTypeList : '', "class='select-4'");?></td>
</tr>
<tr>
