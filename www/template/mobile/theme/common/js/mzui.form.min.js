...
!function(a,b){"use strict";var c,d=".ajaxform",e="Fingerprint",f=function(b){var c=a.getFingerprint(),d=b.find("#fingerprint");d.length||b.append("<input type='hidden' id='fingerprint'  name='fingerprint' value='"+c+"'>"),d.val(c)},g=function(a,b){var c=a.find('[type="submit"]'),d="INPUT"===c.get(0).tagName?"val":"text",e="disable"===b,f=c.data("loading"),g=e?c[d]():c.data("normal");e&&c.data("normal",g),c.attr("disabled",e?"disabled":null),c[d](e?f:g)},h=function(c,e){if(c.length&&!c.data(d)){c.data(d,1);var h=function(b,f){return e&&a.isFunction(e[b])?e[b](f):void c.trigger(b+d,f)},i=function(a){var b=c.find(".form-message");if(b.length){var d=b.find(".content");(d.length?d:b).html(a),b.show()}else alert(a)};h("init"),e.checkfingerprint&&f(c),c.submit(function(d){var e=c.serializeArray(),f={};a.each(e,function(a,b){f[b.name]=b.value}),h("onSubmit",f),g(c,"disable"),a.post(c.attr("action")||b.location.href,a.param(f),function(d,e){if("success"==e){try{d=a.parseJSON(d),"success"===d.result?d.message?(a.messager.success(d.message),d.locate&&setTimeout(function(){location.href=d.locate},1200)):d.locate&&(location.href=d.locate):d.message&&(a.isPlainObject(d.message)?a.each(d.message,function(b,d){var e=c.find("#"+b).closest(".form-group"),f=e.find(".control-message");a.isArray(d)&&d.length&&(d=d.length>1?"<ul><li>"+d.join("</li><li>")+"</li></ul>":d[0]),f.length?f.html(d):e.append('<div class="control-message">'+d+"</div>"),e.addClass("has-error")}):i(d.message))}catch(f){i(d||"No response.")}h("onSuccess",d)}else i("error: "+e),h("onError",e),b.v&&b.v.lang.timeout&&a.messager.warning(b.v.lang.timeout);g(c),h("onComplete",{response:d,status:e})}),d.preventDefault()}).on("change",function(b){c.find(".form-message").hide(),a(b.target).closest(".form-group").removeClass("has-error")})}};a.fn.ajaxform=function(b){return a(this).each(function(){var c=a(this);h(c,a.extend(c.data(),b))})},a.getFingerprint=function(){return c||(a.isFunction(b[e])?c=(new b[e]).get():(c="",a.each(navigator,function(a,b){"string"==typeof b&&(c+=b.length)}))),c},a(function(){a(".ajaxform").ajaxform()})}(Zepto,window);